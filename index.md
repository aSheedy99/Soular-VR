...
<p align="center">
  <img width="520" height="368" src="docs/assets/manyOceans.png?raw=true" alt="Five planets set against a blue and purple star scape. Each planet has a different colour ocean: yellow, pink, red, blue, green. The land on all the planets is white."/>
</p>
...
<p align="center">
  <img width="320" height="320" src="docs/assets/comparisonLabels.png" alt="Two images of the same scene - a set of buttons on a table. The top image shows the buttons only with icons. The bottom shows buttons with descriptive text labels in a black, sans serif font"/>
</p>
